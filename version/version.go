...
func RenderHandler(ctx *gin.Context, object interface{}, method string, args ...interface{}) {
	...
	systemAcceptedVs, _ := utilities.GetContext[[]string](ctx, consts.ContextSystemAcceptedVersions)
	headerVersionIndex, _ := utilities.GetContext[int](ctx, consts.ContextAcceptedVersionIndex)
